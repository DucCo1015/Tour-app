    ...
    <footer className='footer'>
      <Container>
        <Row>
          ...
          <Col lg='3'>
            ...
            <ListGroup className='footer__quick-links'>
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'> 
                ...
                <p className='mb-0'>Binh Duong, Viet Nam</p>
              </ListGroupItem>
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'> 
                <h6 className='mb-0 d-flex align-items-center gap-2'>
                ...
                <p className='mb-0'>tourapp123@gmail.com</p>
              </ListGroupItem>
              <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'> 
                <h6 className='mb-0 d-flex align-items-center gap-2'>
          ...
          <Col lg = '12' className='copyright'>Copyright {year}, by design code web. All rights reserved </Col>
        </Row>
      </Container>
    </footer>
  )
