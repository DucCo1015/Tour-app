          ...
          <Row>
            <Col lg = '6'>
              <div className="hero__content">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut magni beatae recusandae quibusdam tenetur aliquid ratione? Facilis dicta ipsa beatae, quidem quo, officiis eligendi accusantium quasi libero voluptates nesciunt tempore!</p>
              </div>
            </Col>
            <Col lg = '2'>
            ...
            <Col g = '6'>
              <div className="experience__content">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  <br/>
                   Similique nam id eveniet itaque perferendis officiis.</p>
              </div>
        ...
        <Container>
          <Row>
            <Col lg = '12'>
              ...
              <h2 className='testimonial__title'>What your fans say about us</h2>
            </Col>
            <Col lg = '12'>
              <Testimonial />
            </Col>
